...
> Note: This is **not** a contributing guide to "this" repo but rather a guide for any users of your project if you fork this repo. It is included to help you and other contribute to your very own bot!
...
> Note: This guide focuses around writing new tests and using a local environment. You will not be connecting to a chat service like Discord in this guide..
