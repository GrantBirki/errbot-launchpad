# A common class library for interacting with Azure CosmosDB
# I do not use this library for any instance of errbot I have built currently
# I have in the past and it worked for what I needed at the time
# It is suggested to use the DynamoDB lib instead
